...
<?php
	...
	function getParamExist($paramKey="") {
        if ((isset($_GET[$paramKey])) && ($_GET[$paramKey]!="")) {
	...
	function addParams() {
    	//if ($source==1) {
        	echo checkParamExist("ButtonImage","probtn_image");
            echo checkParamExist("ButtonDragImage","probtn_image");
            echo checkParamExist("ButtonOpenImage","probtn_image");
            echo checkParamExist("ButtonInactiveImage","probtn_image");
            echo checkParamExist("ContentURL","probtn_contenturl");
            echo checkParamExist("HintText","probtn_hinttext");
            echo '\'ButtonSize\': {\'W\': '.getParamExist("probtn_size_width").', \'H\': '.getParamExist("probtn_size_height").' },';
			echo '\'ButtonDragSize\': {\'W\': '.getParamExist("probtn_size_width").', \'H\': '.getParamExist("probtn_size_height").' },';
		//}
	}
?>
