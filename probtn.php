        ...
        <div id="options">
            ...
            <?php
                ...
                <table class="form-table">
                    ...
                    <tr class="localSettings">
                        <th scope="row">Button size (width)</th>
                        <td>
                            <fieldset>
                                <label>
                                    <input name="probtn_settings[probtn_size_width]" type="text" id="probtn_size_width"
                                    value="<?php echo (isset($options['probtn_size_width']) && $options['probtn_size_width'] != '') ? $options['probtn_size_width'] : '64'; ?>"/>
                                    <br />
                                    <span class="description">Please enter button width.</span>
                                </label>
                            </fieldset>
                        </td>                       
                    </tr>
                    ...
                    <tr class="localSettings">
                        <th scope="row">Button size (height)</th>
                    <td>
                            <fieldset>
                                <label>
                                    <input name="probtn_settings[probtn_size_height]" type="text" id="probtn_size_height"
                                    value="<?php echo (isset($options['probtn_size_height']) && $options['probtn_size_height'] != '') ? $options['probtn_size_height'] : '64'; ?>"/>
                                    <br />
                                    <span class="description">Please enter button height.</span>
                                </label>
                            </fieldset>
                        </td>
                    </tr>
